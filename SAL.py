...
def train_model_1():
    ...
    a1=Conv2D(24, (5, 5), strides=(1, 1), padding="same", activation='relu')(inputs)
    a1=MaxPooling2D((2,2))(a1)
    
    a1=Conv2D(48, (5, 5), strides=(1, 1), padding="same", activation='relu')(a1)
    a1=MaxPooling2D((2,2))(a1)
    a1=Conv2D(48, (5, 5), strides=(1, 1), padding="same", activation='relu')(a1)
    a1=Flatten()(a1)
    a1=Dropout(0.50)(a1)
    ...
    a1=Dropout(0.50)(a1)
    a1=Dense(71,activation='softmax')(a1)
   
    model=Model(inputs,a1)
...
def train_model():
    ...
    a1=Input(shape=(40,200,1), name='in_layer')
